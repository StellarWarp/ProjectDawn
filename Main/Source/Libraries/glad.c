/*
    ...
    OpenGL loader generated by glad 0.1.36 on Tue Feb 21 11:43:36 2023.
...
int open_gl(void) {
    ...
    for(_index = 0; _index < (sizeof(NAMES) / sizeof(NAMES[0])); _index++) {
        libGL = dlopen(NAMES[_index], RTLD_NOW | RTLD_GLOBAL);
